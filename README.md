...
the pull request's GitHub Actions runs), reviewers from OWNERS
  ...
  execute:
    ...
    steps:
      - uses: cncf/prow-github-actions@v3
        with:
          prow-commands: /assign /unassign /cc /uncc /approve /lgtm /hold /close /reopen /lock /retitle /milestone /remove /area /kind /priority /label /lifecycle /stage /status /help /good-first-issue /retest /test /meow
